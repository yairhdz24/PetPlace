      ...
      >
        <div className="relative h-full pt-16 p-8 lg:pt-8 text-purple-500">
          ...
          <form className="flex items-center gap-2 flex-wrap mt-4 mb-8">
            ...
            <button
              className="bg-blue-700 text-white text-lg px-4 py-2 rounded-lg "
              onClick={(e) => {
                e.preventDefault();
          ...
          <div>
            <div className="grid grid-cols-6 mb-4 p-4">
              <h5 className="col-span-4 font-semibold text-lg text-purple-400">Producto</h5>
              <h5 className="font-semibold text-lg text-purple-400">Cant</h5>
              <h5 className="font-semibold text-lg text-purple-400">Precio</h5>
            </div>
          </div>

            <div className="h-[400px] md:h-[700px] lg:h-[540px] overflow-y-scroll">
              {cart.map((product) => (
                <div key={product.id} className="bg-yellow-100 p-4 rounded-xl mb-4 text-blue-400">
                  ...
                  <div className="grid grid-cols-6 items-center gap-2">
                    ...
                    <div>
                      ...
                      >
                        <RiDeleteBin6Fill className="text-purple-400" />
                      </button>
                    </div>
                  </div>
                </div>
